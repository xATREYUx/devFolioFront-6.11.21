        ...
        <Column id="section-column-right">
          ...
          <AboutMeContainer className="aboutMeContiner">
            ...
            <Paragraph className="aboutMeText">
              ...
              mind - but Col. O'niell (two ells) is the coolest space traveler
              in any time. I could have loved Cary Grant. Data, Data, Data. If
              google can’t answer your question, you’re asking the wrong one.
              Must learn more Python. "The jungian thing." It’s only logical. K.
              I. S. S. Dare to dream. Covid sucks. Dark mode 24/7. The Rock for
